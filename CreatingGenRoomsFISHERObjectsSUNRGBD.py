...
for filename in os.listdir("FisherSUNRGBD"): #for each set of rooms in FisherRooms
    file = open("FisherSUNRGBD/" + filename,"r") #open up set of rooms
...
print("Creating GenRoomsFISHERObjectsSUNRGBDRoomTypeIndex.txt...")
#write global room type to its own file for later use
file = open("GenRoomsFISHERObjectsSUNRGBDRoomTypeIndex.txt","w")
#write objects first
...
file = open("GenRoomsFISHERObjectsSUNRGBD.txt","w")
#write objects first
