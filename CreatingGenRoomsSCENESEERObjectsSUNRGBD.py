...
print("Creating GenRoomsSCENESEERObjectsRoomTypeIndexSUNRGBD.txt...")
#write global room type to its own file for later use
file = open("GenRoomsSCENESEERObjectsRoomTypeIndexSUNRGBD.txt","w")
#write objects first
...
file = open("GenRoomsSCENESEERObjectsSUNRGBD.txt","w")
#write details first
