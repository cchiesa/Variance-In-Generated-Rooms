...
def createGenRoomsObjectsAndRelationships(dir_name):
    ...
    for filename in os.listdir(dir_name): #for each room
        ...
        with open(dir_name+"/" + filename) as json_file:
    ...
    print("Creating GenRooms"+dir_name+"ObjectsAndRelationshipsRoomTypeIndex.txt...")
    #write global room type to its own file for later use
    file = open(dir_name+"RoomTypeIndex.txt","w")
    #write objects first
    ...
    file = open("GenRooms"+dir_name+"ObjectsAndRelationships.txt","w")
    #write details first
...
def createGenRoomsObjects(dir_name):
    ...
    print("Creating GenRooms"+dir_name+"ObjectsRoomTypeIndex.txt...")
    #write global room type to its own file for later use
    file = open("GenRooms"+dir_name+"ObjectsRoomTypeIndex.txt","w")
    #write objects first
    for i in range(0, len(allRoomTypes)):
        file.write(allRoomTypes[i])
        file.write("\n")
    ...
    file = open("GenRooms"+dir_name+"Objects.txt","w")
    #write details first
    for i in range(0, len(globalDetailsList) - 1):
        file.write("\"")
        file.write(globalDetailsList[i])
