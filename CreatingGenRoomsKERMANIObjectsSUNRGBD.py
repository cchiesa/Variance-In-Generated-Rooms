...
for filename in os.listdir("Kermani"): #for each room
    ...
    with open("Kermani/" + filename) as json_file:
...
print("Creating GenRoomsKERMANIObjectsRoomTypeIndexSUNRGBD.txt...")
#write global room type to its own file for later use
file = open("GenRoomsKERMANIObjectsRoomTypeIndexSUNRGBD.txt","w")
#write objects first
...
file = open("GenRoomsKERMANIObjectsSUNRGBD.txt","w")
#write details first
