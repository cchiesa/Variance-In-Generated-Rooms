...
hammingDistances = [] #outer list is each center by index (0-72), each inner list is the list of hamming distances of that index center
...
totalComparisons = 0
for i in range(len(centers)): #cycles through every center, outer list in hammingDistances
