...
for filename in os.listdir("BothKermaniSceneSeerBedroomsBathroomsLivingRooms"): #for each room
    ...
    with open("BothKermaniSceneSeerBedroomsBathroomsLivingRooms/" + filename) as json_file:
...
print("Creating GenRoomsBothKERMANIandSCENESEERBedroomsBathroomsLivingRoomsObjectsRoomTypeIndexSUNRGBD.txt...")
#write global room type to its own file for later use
file = open("GenRoomsBothKERMANIandSCENESEERBedroomsBathroomsLivingRoomsObjectsRoomTypeIndexSUNRGBD.txt","w")
#write objects first
...
file = open("GenRoomsBothKERMANIandSCENESEERBedroomsBathroomsLivingRoomsObjectsSUNRGBD.txt","w")
#write details first
